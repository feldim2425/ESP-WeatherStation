...
#define STATION_CONFIG_TIMEOUT pdMS_TO_TICKS(60000)
#define STATION_CONFIG_PMINTERVAL 10
#define SDSUART_BUF_SIZE 1024

#define STATION_EVENT_TIMER 0x01 // Measurment Timer executed while measuring this bit is used for timeout during standby its used for scheduling
#define STATION_EVENT_DAT_PM 0x02 // PM Sensor recieved Data
#define STATION_EVENT_DAT_PTH 0x04 // Preasure, Temerature, Humidity Sensor recived Data
#define STATION_EVENT_START_PTH 0x08 // Preasure, Temerature, Humidity Sensor recived Data
